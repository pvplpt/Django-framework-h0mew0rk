...
def index(request):
    ...
    <p>В папке lesson1 создал первый проект: <b>django-admin startproject task1</b></p>
    <p>Добавил ip в файл settings.py: <b>ALLOWED_HOSTS = ['127.0.0.1', '192.168.1.5',]</b></p>
    <p>Сменил текущую папку на папку проекта: <b>cd task1</b></p>
    ...
    <p>Создал первое приложение: <b>python3 manage.py startapp firstapp</b></p>
    ...
    path('', include('firstapp.urls')),]</b></p>
    <p>Создал файл <b>urls.py</b> в папке приложения: <br>
    <b>from django.urls import path</b>
